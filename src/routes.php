...
Route::group(['middleware' => \Saadzer\Ticketit\Helpers\LaravelVersion::authMiddleware()], function () use ($main_route, $main_route_path, $admin_route, $admin_route_path) {
    ...
    Route::get("$main_route_path/{id}/complete", 'Saadzer\Ticketit\Controllers\TicketsController@complete')
            ->name("$main_route.complete");

    //Ticket reopen route for permitted user.
    Route::get("$main_route_path/{id}/reopen", 'Saadzer\Ticketit\Controllers\TicketsController@reopen')
