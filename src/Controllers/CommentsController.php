...
class CommentsController extends Controller
{
    ...
    {
        $this->middleware('Saadzer\Ticketit\Middleware\IsAdminMiddleware', ['only' => ['edit', 'update', 'destroy']]);
        $this->middleware('Saadzer\Ticketit\Middleware\ResAccessMiddleware', ['only' => 'store']);
    }
