...
@section('footer')
	<script src="https://cdn.datatables.net/v/bs/dt-{{ Saadzer\Ticketit\Helpers\Cdn::DataTables }}/r-{{ Saadzer\Ticketit\Helpers\Cdn::DataTablesResponsive }}/datatables.min.js"></script>
	<script>
	    $('.table').DataTable({
	        processing: false,
	        serverSide: true,
