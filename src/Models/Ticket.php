...
class Ticket extends Model
{
    ...
    {
        return $this->belongsTo('Saadzer\Ticketit\Models\Status', 'status_id');
    }
    ...
    {
        return $this->belongsTo('Saadzer\Ticketit\Models\Priority', 'priority_id');
    }
    ...
    {
        return $this->belongsTo('Saadzer\Ticketit\Models\Category', 'category_id');
    }
    ...
    {
        return $this->belongsTo('Saadzer\Ticketit\Models\Agent', 'agent_id');
    }
    ...
    {
        return $this->hasMany('Saadzer\Ticketit\Models\Comment', 'ticket_id');
    }
...
//    /**
    ...
    //    {
    //        return $this->hasMany('Saadzer\Ticketit\Models\Audit', 'ticket_id');
    //    }
    //
