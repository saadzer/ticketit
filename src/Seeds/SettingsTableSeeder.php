...
class SettingsTableSeeder extends Seeder
{
    ...
    public function getDefaults()
    {
        return [
            ...
            'email.footer_link'      => 'https://github.com/saadzer/ticketit',
...
//            'admin_ids' => [1],
             ...
             */
            'summernote_options_json_file' => 'vendor/saadzer/ticketit/src/JSON/summernote_init.json',
             ...
             */
            'routes' => base_path('vendor/saadzer/ticketit/src').'/routes.php',
